...
const LineChart4 = () => {
        ...
        const interval = setInterval(() => {
            ...
            fetch('https://api.thingspeak.com/channels/2490599/fields/4.json?api_key=${apiKey}&results=300%27;')
                ...
                .then((data) => {
                    ...
                    const data2 = data.feeds.map((entry) => entry.field4);
                    // console.log(labels);
                    // console.log(data2);
                    var f = 0;
                    ...
                    if (f === 0) {
                        console.log(chartData.datasets[0].data[299])
    ...
    return (
        ...
        <div style={{
            width: '80vw', position: 'absolute', left: '10vw', top: '200vh', height: '70vh',right:'10vw'
        }}>
