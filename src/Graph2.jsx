...
const LineChart2 = () => {
    ...
    useEffect(() => {
        ...
        const interval = setInterval(() => {
            ...
            fetch('https://api.thingspeak.com/channels/2513220/fields/1.json?api_key=${apiKey}&results=300%27;')
                .then((res) => res.json())
                .then((data) => {
                    // console.log(data);
                    ...
                    const data2 = data.feeds.map((entry) => entry.field1);
                    // console.log(labels);
                    // console.log(data2);
                    var f = 0;
    ...
    return (
        ...
        <div style={{
            width: '80vw', position: 'absolute', left: '10vw', top: '110vh', height: '70vh',right:'10vw'
        }}>
